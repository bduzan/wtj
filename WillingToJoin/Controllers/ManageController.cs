    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.Error ? "Your profile could not be updated."
            ...
            ViewBag.RoleNames = await UserManager.GetRolesAsync(userId);
        ...
        // POST: /Manage/Index
        [HttpPost]
        public async Task<ActionResult> Index(IndexViewModel model, params string[] selectedRole)
        {
            var userId = User.Identity.GetUserId();
